...
public enum ModArmorMaterials implements ArmorMaterial {
    TITANIUM("titanium", 35, Util.make(new EnumMap(ArmorItem.Type.class), (map) -> {
        map.put(ArmorItem.Type.BOOTS, 3);
        map.put(ArmorItem.Type.LEGGINGS, 6);
        map.put(ArmorItem.Type.CHESTPLATE, 8);
        map.put(ArmorItem.Type.HELMET, 3);
    }), 19, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 2.0F, 0.1F, () ->
    ...
    RUBY("ruby", 35, Util.make(new EnumMap(ArmorItem.Type.class), (map) -> {
        ...
        map.put(ArmorItem.Type.HELMET, 5);
            ...
            Ingredient.ofItems(new ItemConvertible[]{ModItems.RUBY})),
    STEEL("steel", 35, Util.make(new EnumMap(ArmorItem.Type.class), (map) -> {
        map.put(ArmorItem.Type.BOOTS, 3);
        map.put(ArmorItem.Type.LEGGINGS, 6);
