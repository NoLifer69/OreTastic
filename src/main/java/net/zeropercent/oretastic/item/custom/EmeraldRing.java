...
public class EmeraldRing extends Item {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        if(user instanceof PlayerEntity){
            ...
            PlayerEntity.addStatusEffect(new StatusEffectInstance(StatusEffects.JUMP_BOOST, 4800, 1));
            ...
            user.getItemCooldownManager().set(ModItems.STEEL_RING, 5000);
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
            tooltip.add(Text.literal("Gives You The Jump Boost Effect For 4 Minutes").formatted(Formatting.GREEN));
