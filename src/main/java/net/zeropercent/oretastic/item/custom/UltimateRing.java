...
public class UltimateRing extends Item {
    public UltimateRing(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        if(user instanceof PlayerEntity){
            ...
            PlayerEntity.addStatusEffect(new StatusEffectInstance(StatusEffects.NIGHT_VISION, 12000, 1));
